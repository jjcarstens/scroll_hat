defmodule ScrollHat.Font.Unicode do
  @moduledoc """
  Large 5x7 Unicode Font

  Transposed from https://github.com/pimoroni/scroll-phat-hd/blob/master/library/scrollphathd/fonts/font5x7unicode.py
  """
  @behaviour ScrollHat.Font

  def char_matrix(char, brightness \\ 0xFF)

  def char_matrix(0x0, b) do
    [
      [b, b, b, b, b],
      [b, b, b, b, b],
      [b, b, b, b, b],
  ...
  def char_matrix(0x99, b) do
    [[0x0, 0x0], [0x0, 0x0], [0x0, b], [0x0, b], [0x0, b], [b, b], [b, b]]
  end
